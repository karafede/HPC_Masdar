...
## 10km
url_list_data = "ftp://karafede:Password08@nrt3.modaps.eosdis.nasa.gov/allData/6/MOD04_L2/2017/" 
...
url = paste("ftp://karafede:Password08@nrt3.modaps.eosdis.nasa.gov/allData/6/MOD04_L2/2017/",folder_day, "/", sep = "")
...
Overpass_times <- read.csv("/disk3/fkaragulian/MODIS_AOD/Overpass_times_Terra.csv")
